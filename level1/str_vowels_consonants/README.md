...
This program receives a string, counts how many vowels and consonants are present, and displays both counts.

# Example:

txt = "How many vowels and consonants are in this sentence?"
